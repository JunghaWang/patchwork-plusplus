...
void GroundSegmentationServer::EstimateGround(sensor_msgs::msg::PointCloud2::SharedPtr msg) {
...
void GroundSegmentationServer::PublishClouds(const Eigen::MatrixX3f &est_ground,
  ...
  ground_publisher_->publish(patchworkpp_ros::utils::EigenMatToPointCloud2(est_ground, header));
  nonground_publisher_->publish(patchworkpp_ros::utils::EigenMatToPointCloud2(est_nonground, header));
}
